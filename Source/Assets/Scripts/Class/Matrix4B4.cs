...
public class Matrix4B4
{
    ...
    public static Matrix4B4 operator *(Matrix4B4 lhs, Matrix4B4 rhs)
    {
        ...
        RET.values[0, 0] = lhs.values[0, 0] * rhs.values[0, 0] + lhs.values[1, 0] * rhs.values[0, 1] + lhs.values[2, 0] * rhs.values[0, 2] + lhs.values[3, 0] * rhs.values[0, 3]; 
        RET.values[0, 1] = lhs.values[0, 1] * rhs.values[0, 0] + lhs.values[1, 1] * rhs.values[0, 1] + lhs.values[2, 1] * rhs.values[0, 2] + lhs.values[3, 1] * rhs.values[0, 3];
        RET.values[0, 2] = lhs.values[0, 2] * rhs.values[0, 0] + lhs.values[1, 2] * rhs.values[0, 1] + lhs.values[2, 2] * rhs.values[0, 2] + lhs.values[3, 2] * rhs.values[0, 3];
        RET.values[0, 3] = lhs.values[0, 3] * rhs.values[0, 0] + lhs.values[1, 3] * rhs.values[0, 1] + lhs.values[2, 3] * rhs.values[0, 2] + lhs.values[3, 3] * rhs.values[0, 3];

        RET.values[1, 0] = lhs.values[0, 0] * rhs.values[1, 0] + lhs.values[1, 0] * rhs.values[1, 1] + lhs.values[2, 0] * rhs.values[1, 2] + lhs.values[3, 0] * rhs.values[1, 3];
        RET.values[1, 1] = lhs.values[0, 1] * rhs.values[1, 0] + lhs.values[1, 1] * rhs.values[1, 1] + lhs.values[2, 1] * rhs.values[1, 2] + lhs.values[3, 1] * rhs.values[1, 3];
        RET.values[1, 2] = lhs.values[0, 2] * rhs.values[1, 0] + lhs.values[1, 2] * rhs.values[1, 1] + lhs.values[2, 2] * rhs.values[1, 2] + lhs.values[3, 2] * rhs.values[1, 3];
        RET.values[1, 3] = lhs.values[0, 3] * rhs.values[1, 0] + lhs.values[1, 3] * rhs.values[1, 1] + lhs.values[2, 3] * rhs.values[1, 2] + lhs.values[3, 3] * rhs.values[1, 3];


        RET.values[2, 0] = lhs.values[0, 0] * rhs.values[2, 0] + lhs.values[1, 0] * rhs.values[2, 1] + lhs.values[2, 0] * rhs.values[2, 2] + lhs.values[3, 0] * rhs.values[2, 3];
        RET.values[2, 1] = lhs.values[0, 1] * rhs.values[2, 0] + lhs.values[1, 1] * rhs.values[2, 1] + lhs.values[2, 1] * rhs.values[2, 2] + lhs.values[3, 1] * rhs.values[2, 3];
        RET.values[2, 2] = lhs.values[0, 2] * rhs.values[2, 0] + lhs.values[1, 2] * rhs.values[2, 1] + lhs.values[2, 2] * rhs.values[2, 2] + lhs.values[3, 2] * rhs.values[2, 3];
        RET.values[2, 3] = lhs.values[0, 3] * rhs.values[2, 0] + lhs.values[1, 3] * rhs.values[2, 1] + lhs.values[2, 3] * rhs.values[2, 2] + lhs.values[3, 3] * rhs.values[2, 3];

        RET.values[3, 0] = lhs.values[0, 0] * rhs.values[3, 0] + lhs.values[1, 0] * rhs.values[3, 1] + lhs.values[2, 0] * rhs.values[3, 2] + lhs.values[3, 0] * rhs.values[3, 3];
        RET.values[3, 1] = lhs.values[0, 1] * rhs.values[3, 0] + lhs.values[1, 1] * rhs.values[3, 1] + lhs.values[2, 1] * rhs.values[3, 2] + lhs.values[3, 1] * rhs.values[3, 3];
        RET.values[3, 2] = lhs.values[0, 2] * rhs.values[3, 0] + lhs.values[1, 2] * rhs.values[3, 1] + lhs.values[2, 2] * rhs.values[3, 2] + lhs.values[3, 2] * rhs.values[3, 3];
        RET.values[3, 3] = lhs.values[0, 3] * rhs.values[3, 0] + lhs.values[1, 3] * rhs.values[3, 1] + lhs.values[2, 3] * rhs.values[3, 2] + lhs.values[3, 3] * rhs.values[3, 3];
